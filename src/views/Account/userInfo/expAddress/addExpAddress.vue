<template>
  <div class="main">
    <mt-header title="填写收货地址" class="gmkt-header"></mt-header>
    <ul class="nav">
      <div class="nav-bac">
        <div class="nav-item">
          <mt-field label="收货人" placeholder="请输入收货人姓名" v-model="user"></mt-field>
          <mt-field label="联系电话" placeholder="请输入收货人联系电话" v-model="phone"></mt-field>
    ...
    <div>
      ...
      <mt-button size="normal" type="primary" class="right" @click="saveAddress">
...
//        if (!val) {
//          if (this.isBlank(this.region) && !this.isCancel) {
...
//      }
    ...
    methods: {
      ...
      saveAddress () {
        this.postRequest('gcwwwifc/createOrUpdateExpressAddress', {
          'IsDefault': this.isDefault === true ? 1 : 0,
          'Consignee': this.user.replace(/\s/g, ''),
          'ExpressMobile': this.phone,
          'ExpressAddress': this.addressDetail,
